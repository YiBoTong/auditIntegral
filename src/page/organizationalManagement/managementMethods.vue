<!--
****--@date     2018-11-09 15:54
****--@author   XXL
****--@describe 管理办法
-->
<template>
  <div class="management-methods-container">
    <div class="management-methods-top">
    ...
    <div class="management-methods-table">
      <el-table
        :data="tableData"
        style="width: 100%">
        <el-table-column
    ...
    <div class="management-methods-pagination">
      <el-pagination
